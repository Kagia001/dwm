...
static const char *colemakkeyboard[] = {"xmodmap", "/home/p/.config/xmodmap",
                                        NULL};
...
static const char *upvol[] = {"amixer",   "-c",     "1",  "sset", "Master",
                              "playback", "volume", "-M", "2%+",  NULL};
static const char *downvol[] = {"amixer",   "-c",     "1",  "sset", "Master",
                                "playback", "volume", "-M", "2%-",  NULL};
static const char *mutevol[] = {"amixer", "-c",     "1", "sset",
                                "Master", "toggle", NULL};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2)
        TAGKEYS(XK_4, 3){ControlMask | ShiftMask, XK_Escape, quit, {0}},
};
